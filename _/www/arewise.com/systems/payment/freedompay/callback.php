...
if (empty($arrRequest['pg_sig']) || !PG_Signature::check($arrRequest['pg_sig'], $thisScriptName, $arrRequest, $param['secret_key_payment'])){
...
$objResponse->addChild('pg_sig', PG_Signature::makeXML($thisScriptName, $objResponse, $param['secret_key_payment']));
